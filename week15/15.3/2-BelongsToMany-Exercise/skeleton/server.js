 ...
 * -/-/-/-/-/-/-/-/-/-/-/-/-/ */
  ...
  *    (And don't forget to make the ManagerStore model (no attributes needed)).
  ...
  *		NOTE: The managers have already been made, for your convenience
  *
...
app.get('/managers/:name', function(req, res){
